...
export function ConfirmDialog({
  ...
  useEffect(() => {
    if (!open) return;
    // Usando apenas overflow:hidden sem position:fixed no body, pois
    // position:fixed no body quebra position:fixed dos filhos no iOS Safari,
    // causando o nav mobile "pular" para o meio da tela.
