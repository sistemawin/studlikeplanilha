  ...
  return (
    <main className="min-h-dvh w-full max-w-full bg-slate-50 text-slate-950">
      ...
      <nav
        ...
        className={`${adminView ? "hidden" : "grid"} mobile-bottom-nav grid-cols-5 overflow-hidden border-t border-slate-800 bg-slate-950/96 px-2 pb-[calc(0.45rem+env(safe-area-inset-bottom))] pt-2 shadow-[0_-10px_30px_rgba(15,23,42,0.24)] backdrop-blur-xl xl:hidden`}
      >
